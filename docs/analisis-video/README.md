...
|---|---|---|
| [`00-diccionario-metricas.md`](00-diccionario-metricas.md) | Qué es exactamente cada métrica, quién la produce (IA / asistida / manual) y con qué precisión se acepta | Borrador — **pendiente de revisión del CT** |
...
- **Fase 0 — Definiciones y protocolo** ← acá estamos
  ...
  - [ ] Revisión del CT sobre las decisiones pendientes del diccionario
...
- **Fase 4 — UI de corrección** e integración con la tabla `eventos`.
...
5. **Licencia**: si el módulo se comercializa, no se usa Ultralytics YOLO
...
- Las coordenadas del tracking no aplican la normalización ni el espejado de
  `eventos.zona_x/zona_y`. Ver la sección de coordenadas del diccionario.
