    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', background: 'var(--bg)', padding: '20px', alignItems: 'center', boxSizing: 'border-box' }}>
      <div style={{ background: 'var(--panel)', padding: '30px', borderRadius: '12px', border: '1px solid var(--border)', width: '100%', maxWidth: '800px', flex: 1, display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingRight: '15px', color: '#ccc', fontSize: '0.9rem', lineHeight: '1.6' }}>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>2. PRIVACIDAD Y PROTECCIÓN DE DATOS SENSIBLES</h3>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>3. ALMACENAMIENTO Y SEGURIDAD (Infraestructura)</h3>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>4. USO DE DISPOSITIVOS COMPARTIDOS (Modo Kiosco)</h3>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>5. PROPIEDAD INTELECTUAL</h3>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>6. LIMITACIÓN GENERAL DE RESPONSABILIDAD (Cláusula "As-Is")</h3>
          ...
          <h3 style={{ color: 'var(--text)', marginTop: '20px', fontWeight: 'bold' }}>7. CUMPLIMIENTO DE LA LEY DE PROTECCIÓN DE DATOS PERSONALES (LEY 25.326)</h3>
